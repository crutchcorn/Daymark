...
import app.drawmark.android.lib.textcanvas.selection.updateSelectionTouchMode
...
internal fun Modifier.defaultTextFieldPointer(
    ...
    this.updateSelectionTouchMode { state.isInTouchMode = it }
        ...
        .pointerInput(manager.mouseSelectionObserver, manager.touchSelectionObserver) {
            awaitSelectionGestures(manager.mouseSelectionObserver, manager.touchSelectionObserver)
        }
